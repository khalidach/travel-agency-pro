...
export function Header({ dict, lang }: HeaderProps) {
  ...
  return (
    <header className="h-16 border-b border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 px-4 md:px-8 flex items-center justify-between sticky top-0 z-30 transition-colors">
      ...
      <div className="flex items-center gap-2 md:gap-4">
        ...
        <div className="relative" ref={dropdownRef}>
          ...
          >
            <div className="w-8 h-8 rounded-full bg-teal-100  flex items-center justify-center text-brand">
              <User size={18} />
            </div>
            <ChevronDown
              size={14}
